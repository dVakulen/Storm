...
//     */
//    public List<int> emit(string streamId, Tuple anchor, List<Object> tuple) {
...
//     * @return the list of task ids that this new tuple was sent to
//     */
//    public List<int> emit(Collection<Tuple> anchors, List<Object> tuple) {
...
//     * @return the list of task ids that this new tuple was sent to
//     */
//    public List<int> emit(Tuple anchor, List<Object> tuple) {
...
//    @Override
//    public List<int> emit(string streamId, Collection<Tuple> anchors, List<Object> tuple) {
