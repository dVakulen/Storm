...
//    private Map<int,Map<int, Map<string, IMetric>>> _registeredMetrics;
//    private clojure.lang.Atom _openOrPrepareWasCalled;

    
//    public TopologyContext(StormTopology topology, Map stormConf,
//            Map<int, string> taskToComponent, Map<string, List<int>> componentToSortedTasks,
//            Map<string, Map<string, Fields>> componentToStreamToFields,
//            string stormId, string codeDir, string pidDir, int taskId,
//            int workerPort, List<int> workerTasks, Map<string, Object> defaultResources,
...
//        List<int> tasks = new ArrayList<int>(getComponentTasks(getThisComponentId()));
...
//        for (Map<int, Map<string, IMetric>> taskIdToNameToMetric: _registeredMetrics.values()) {
